...
namespace Catalog.API.Data
{
    ...
    public class CatalogContextSeed
    {
        ...
        {
            bool existProduct = await productCollection.FindSync(p => true).AnyAsync();

            if (!existProduct)
            {

                await productCollection.InsertManyAsync(await GetPreConfiguredProducts());

            }
        }

        private static async Task<IEnumerable<Product>> GetPreConfiguredProducts()
        {
